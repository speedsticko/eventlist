                ...
                <div class="mdl-layout__tab-panel is-active" id="overview">
                    <div class="mdl-grid" style="max-width: 860px;">
                        ...
                        <div class="mdl-cell mdl-cell--4-col mdl-cell--2-col-tablet" style="padding: 20px 0;">
                            <button id="prev-date" class="mdl-button mdl-js-button mdl-button--icon"><i class="material-icons">&#xE5CB;</i></button>
                            <button id="next-date" class="mdl-button mdl-js-button mdl-button--icon"><i class="material-icons">&#xE5CC;</i></button>  <span id="startDate"></span> to <span id="endDate"></span>
                        </div>
                        <div id="period-type-group" class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet" style="padding: 20px 0;">
